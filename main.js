...
if (!opts['test']) {
  if (global.db) {
    setInterval(async () => {
      ...
      if (opts['autocleartmp'] && (global.support || {}).find) (tmp = [os.tmpdir(), 'tmp', 'YallicoSexo'], tmp.forEach((filename) => cp.spawn('find', [filename, '-amin', '3', '-type', 'f', '-delete'])));
    }, 30 * 1000);
  }
}
...
try {
let listaDirectorios = readdirSync('./YallicoSexo/');
let SBprekey = []
listaDirectorios.forEach(directorio => {
if (statSync(`./YallicoSexo/${directorio}`).isDirectory()) {
let DSBPreKeys = readdirSync(`./YallicoSexo/${directorio}`).filter(fileInDir => {
return fileInDir.startsWith('pre-key-') /*|| fileInDir.startsWith('app-') || fileInDir.startsWith('session-')*/
})
SBprekey = [...SBprekey, ...DSBPreKeys]
DSBPreKeys.forEach(fileInDir => {
unlinkSync(`./YallicoSexo/${directorio}/${fileInDir}`)
})
}
})
...
const directories = ['./YallicoSession/', './YallicoSexo/']
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '@user\n𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗧𝗘 𝗗𝗔 𝗟𝗔 𝗕𝗜𝗘𝗡𝗩𝗘𝗡𝗜𝗗𝗔 𝗔𝗟 𝗚𝗥𝗨𝗣𝗢 🐈';
  conn.bye = '@user\n𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗗𝗜𝗖𝗘 𝗤𝗨𝗘 𝗡𝗢 𝗙𝗨𝗜𝗦𝗧𝗘 𝗗𝗜𝗚𝗡𝗫 𝗗𝗘 𝗘𝗦𝗧𝗔𝗥 𝗔𝗖𝗔 🐈';
  conn.spromote = '𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗔𝗡𝗨𝗡𝗖𝗜𝗔 𝗤𝗨𝗘 @user 𝗔𝗛𝗢𝗥𝗔 𝗘𝗦 𝗔𝗗𝗠𝗜𝗡 𝗗𝗘𝗟 𝗚𝗥𝗨𝗣𝗢 🐈';
  conn.sdemote = '𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗔𝗡𝗨𝗡𝗖𝗜𝗔 𝗤𝗨𝗘 @user 𝗬𝗔 𝗡𝗢 𝗘𝗦 𝗔𝗗𝗠𝗜𝗡 𝗗𝗘𝗟 𝗚𝗥𝗨𝗣𝗢 🐈';
  conn.sSubject = '𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗔𝗡𝗨𝗡𝗖𝗜𝗔 𝗦𝗢𝗕𝗥𝗘 𝗘𝗟 𝗖𝗔𝗠𝗕𝗜𝗢 𝗗𝗘 𝗡𝗢𝗠𝗕𝗥𝗘 𝗗𝗘𝗟 𝗚𝗥𝗨𝗣𝗢 🐈';
  conn.sIcon = '𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗔𝗡𝗨𝗡𝗖𝗜𝗔 𝗤𝗨𝗘 𝗟𝗔 𝗙𝗢𝗧𝗢 𝗗𝗘𝗟 𝗚𝗥𝗨𝗣𝗢 𝗙𝗨𝗘 𝗖𝗔𝗠𝗕𝗜𝗔𝗗𝗔 🐈';
  conn.sRevoke = '𝗦𝗘𝗣𝗛𝗜𝗥𝗢𝗧𝗛 𝗔𝗡𝗨𝗡𝗖𝗜𝗔 𝗤𝗨𝗘 𝗔𝗛𝗢𝗥𝗔 𝗘𝗟 𝗘𝗡𝗟𝗔𝗖𝗘 𝗙𝗨𝗘 𝗖𝗔𝗠𝗕𝗜𝗔𝗗𝗢 🐈';
